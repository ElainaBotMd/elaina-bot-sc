...
const sections = [
   {
	title: `${htjava} SEWA ✦-------`,
	rows: [
	    {title: "🔖 HEMAT", rowId: '.order *Paket:* 10K • Sewa', description: 'PRICE: ' + sh + 'k (15 Hari)' },
	    {title: "🔖 NORMAL", rowId: '.order *Paket:* 15K • Sewa', description: 'PRICE: ' + sn + 'k (1 bulan)' },
	{title: "🔖 Permanen", rowId: '.order *Paket:* 30K • Sewa', description: 'PRICE: ' + sv + 'k (60hari)' },
	]
    }, {
	...
	{title: "🌟 PERMANENT", rowId: '.order *Paket:* 25K • Premium', description: 'PRICE: ' + ppm + 'k (UNLIMITED)' },
	]
    }, {
